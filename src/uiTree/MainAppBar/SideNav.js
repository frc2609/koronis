...
import { Home, FiberManualRecord, Settings } from '@material-ui/icons';
    ...
    <div>
      <Drawer open={this.props.menuState} onClose={this.props.closeMenuCallback}>
        <List>
          ...
          <SectionLink to='/settings' title='Settings' icon={<Settings />} closeMenuCallback={this.props.closeMenuCallback} />
        </List>
      </Drawer>
    </div>
  );}
